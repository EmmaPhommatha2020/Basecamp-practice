...
//Code Here
let evenNumbers = mixedNumbers.filter(index => index%2 === 0);
...
//Code Here
let postTaxPrices = prices.map(index => index * 1.07);
...
//Code Here
let totalPopulation = populations.reduce((acc, item) => acc + item, 0);
...
myStrongest; // return => => [ { monster: 'Bulbabunny', CP: 250 },
...
*/
//Code Here
let ordersTotal = orders.map(item => item.price * (item.tax +1));
...
*/
//Code Here
let bob = purchases.filter(item => item.owner === "Bob");

console.log(bob); // return => [ { owner: 'Bob', price: 75 },
                              // { owner: 'Bob', price: 73 },
                              // { owner: 'Bob', price: 119 },
                              // { owner: 'Bob', price: 68 },
                              // { owner: 'Bob', price: 50 },
...
let bobsTotal = bob.reduce((acc, item) => acc + item.price, 0);

console.log(bobsTotal); // return => 891
