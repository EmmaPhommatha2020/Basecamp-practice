...
makePerson("Emma", 30, 2222); // return => { name: 'Emma', birthday: 30, ssn: 2222 }
...
makeCard(123, 01, 01); // return => { cardNumber: 123, expirationDate: 1, securityCode: 1 }
