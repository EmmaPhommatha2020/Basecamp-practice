...
var myName = new Employee("Emma", "Phommatha", "emma@emma", 24);
myName.makeWidget();
myName; // return => Employee {
        // first_name: 'Emma',
        // last_name: 'Phommatha',
        // email: 'emma@emma',
        // age: 24 } 
...
class Manager {
  ...
  fire(number) {
    return this.reports.splice(number, 1);
  }
}
newManager = new Manager("Emma", "Phommatha", "emma@emma", 24);
...
class ProgressiveManager {
  ...
  updateTitle() {
    if (this.reports.length === 0) {
      ...
      console.log("hitting correct", this.title);
  ...
  fire(number) {
    this.reports.splice(number, 1);
    this.updateTitle();
    this.bonus += 100;
  }
}

newManager = new ProgressiveManager("Emma", "Phommatha", "emma@ema", 24);

newManager; // return => ProgressiveManager {
            // first_name: 'Emma',
            // last_name: 'Phommatha',
            // email: 'emma@ema',
            // age: 24,
...
newMachine = new Machine(); // return => Machine {
